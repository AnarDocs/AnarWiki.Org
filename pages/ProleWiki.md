...
ProleWiki was created on September 30, 2020, and has since expanded to
nine languages with over 3,000 articles. The project explicitly adopts a
Marxist-Leninist ideological framework and has implemented various
governance structures, including an account request system and
democratic reforms allowing editors to vote on new members. The site
experienced several internal conflicts, including what it terms a "purge
of patriotic socialists" in 2022 and an "ultra-left subversion attempt"
by a Hoxhaist editor.

The encyclopedia's stated goal is to build an anti-imperialist
proletarian collection of information, though its rigid adherence to
orthodox Marxist-Leninist positions often leads to dismissive or hostile
treatment of other socialist tendencies, particularly anarchism.

## Misrepresentation of Anarchism

ProleWiki's article on anarchism perpetuates several fundamental
misconceptions about anarchist theory that have been standard in
Marxist-Leninist discourse since the 19th century disputes between Marx
and Bakunin. These mischaracterizations reveal not just disagreement but
a failure to engage seriously with anarchist political philosophy.
...
how concentrated authority reproduces class relations regardless of who
...
### Understanding Exploitation and Class Struggle

ProleWiki asserts that "anarchism does not go beyond general phrases
against exploitation, it does not understand what the causes of
exploitation are, nor the class struggle as a creative force for the
realization of socialism." This claim is demonstrably false and reflects
ignorance of anarchist economic theory.

Anarchist theorists have provided detailed analyses of exploitation and
class relations:
...
Anarchists understand class struggle not as something directed by a
revolutionary party toward state seizure, but as direct action by
workers and oppressed peoples to reclaim control over their own lives.
This is not a rejection of class analysis but a different strategic
understanding of how liberation occurs.

### Lenin's False Distinctions

ProleWiki reproduces Lenin's characterization of differences between
Marxists and anarchists, which misrepresents anarchist positions on
three key points:

**On the withering away of the state:** Lenin claimed anarchists "want
to completely destroy the State overnight, without understanding the
...
**On replacing the state machine:** Anarchists do not have "an
...
organizational model based on direct democracy rather than
representative institutions.

**On using state power:** The anarchist rejection of using state power
...
Anarchism's actual philosophical basis rests on several key principles
that ProleWiki either ignores or mischaracterizes:

- **Anti-authoritarianism:** Opposition to all forms of hierarchical
  domination, not just capitalist economic relations
- **Mutual aid:** Recognition of cooperation as a fundamental
  evolutionary and social force
- **Direct action:** Emphasis on autonomous struggle by oppressed
  peoples rather than delegation to representatives or parties
- **Prefigurative politics:** Building new social relations within
  revolutionary movements themselves
- **Federalism:** Organizational structures based on voluntary
  association and recallable delegation rather than centralized command

These principles emerge from materialist analysis of how power operates
in society, not from abstract idealism or petit-bourgeois ideology.

## Historical Practice

The characterization of anarchism as impractical or utopian ignores
substantial historical evidence of anarchist organizing effectiveness.
...
ProleWiki's treatment of anarchism exemplifies how ideological
commitment can override serious engagement with opposing viewpoints.
Rather than addressing anarchist theory on its own terms, the
encyclopedia reproduces century-old polemics that mischaracterize
anarchist positions and ignore both theoretical developments and
historical evidence. While ProleWiki serves as a resource for
Marxist-Leninist perspectives, its handling of anarchism demonstrates
the limitations of approaching political theory as orthodoxy to be
defended rather than as questions to be investigated critically.
